...
// Query: *[_type == "order" && clerkUserId == $userId] | order(orderDate desc) {      ...,      products[] {        _key,          // <- stable line-item key (React key)        quantity,        product-> {          _id,         // <- product id you asked for          name,          price,          currency,          image        }      }    }
